from states_lite import Teacher, Subject, Section, Table_T
from helpfull_lite import print_to_csv, print_tt, print_tt_stats, print_tt_faculty, setup, input_file
import states_lite as states
import WFC_lite as WFC
...
def init_faculty(dims, faculty_dict:dict, subjects_dict:dict[str,list[Subject]], elec_faculty, faculty_availability_dict) -> list[Teacher]:
    ...
    for faculty_name, faculty_info in faculty_dict.items():
        ...
        for subj_nm in faculty_info:
            ...
            n_active_slots += subjects_dict[subj_nm][0].total_slots_per_week

        fac.setActiveSlots(n_active_slots)
        fac.setAvailability(
...
def main(
    ...
    faculty_dict:dict, faculty_subj_sec_dict,
    ...
    table: Table_T = setup(dims5,
        ...
        subjects_dict, faculty_subj_sec_dict,
...
if __name__ == '__main__':
    import os
    file_name = './lite/config_lite.txt'
